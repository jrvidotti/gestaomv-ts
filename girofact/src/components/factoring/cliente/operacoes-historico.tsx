...
export function OperacoesHistorico({ operacoes, isLoading }: OperacoesHistoricoProps) {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button variant="outline" size="sm" asChild>
            <Link to="/admin/factoring/operacoes" search={{ cliente: operacoes[0]?.id }}>
                ...
                <TableRow key={operacao.id}>
                  ...
                  <TableCell>
                    <div className="text-sm">
                      {operacao.status === "efetivada" || operacao.status === "liquidada"
