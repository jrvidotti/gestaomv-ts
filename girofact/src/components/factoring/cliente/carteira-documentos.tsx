...
export function CarteiraDocumentos({
	documentos,
	isLoading,
}: CarteiraDocumentosProps) {
					...
					<div className="flex items-center justify-between">
						...
						<div className="text-right">
							...
							<p className="text-2xl font-bold">
								{formatCurrency(documentos.total.valor)}
							</p>
						</div>
					</div>
				</div>
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<div className="text-sm text-yellow-700 space-y-1 mt-1">
									{documentos.vencidos.count > 0 && (
										<p>
											• {documentos.vencidos.count} documento(s) vencido(s) no
											valor de {formatCurrency(documentos.vencidos.valor)}
										</p>
									)}
									{documentos.protestados.count > 0 && (
										<p>
											• {documentos.protestados.count} documento(s)
											protestado(s) no valor de{" "}
											{formatCurrency(documentos.protestados.valor)}
										</p>
									)}
								</div>
							</div>
