...
import { DollarSign, TrendingUp, TrendingDown, ArrowUpDown, AlertCircle } from "lucide-react";
...
export function SaldoLancamentos({ saldo, isLoading }: SaldoLancamentosProps) {
  ...
  const percentualEntradas = totalMovimentacao > 0 
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center p-6 bg-muted/50 rounded-lg">
          ...
          <div className={`text-3xl font-bold ${saldo.saldoAtual >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 border rounded-lg">
            ...
            <div className="space-y-1">
              ...
              <Progress value={100 - percentualEntradas} className="h-2 bg-green-100" />
            </div>
          </div>
        </div>
                    ...
                    <div>
                      <div className="text-sm font-medium">
                        {lancamento.descricao || 
                          (lancamento.tipoLancamento === "entrada" ? "Entrada" : "Saída")}
                      </div>
