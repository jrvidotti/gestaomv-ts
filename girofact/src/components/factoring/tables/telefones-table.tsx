...
export function TelefonesTable({ telefones, onChange, isLoading }: TelefonesTableProps) {
  ...
  const handleFieldChange = (index: number, field: keyof TelefoneDto, value: any) => {
    const updatedTelefones = [...telefones];
    updatedTelefones[index] = {
      ...updatedTelefones[index],
      [field]: value,
                ...
                <TableRow key={telefone.id || index}>
                  ...
                  <TableCell>
                    {telefone.isEditing ? (
                      ...
                      <Badge variant={telefone.inativo ? "destructive" : "default"}>
                        {telefone.inativo ? "Inativo" : "Ativo"}
                      </Badge>
                    )}
                  </TableCell>
