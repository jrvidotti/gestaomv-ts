...
function OperacaoDetailsPage() {
	...
	const getActionButtons = () => {
		...
		const buttons = [];
		const isPending =
			isApproving || isEffective || isLiquidating || isCanceling;
						...
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div>
									...
									<div className="mt-1 font-mono">{operacao.uid}</div>
								</div>
							</div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div>
									...
									<div className="mt-1">{formatDate(operacao.criadoEm)}</div>
								</div>
							</div>
						...
						<CardContent className="space-y-4">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								...
								<div>
									...
									<div className="mt-1">{operacao.carteira.banco}</div>
								</div>
							</div>
