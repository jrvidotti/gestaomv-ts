...
import { Users, Edit, ArrowLeft, Mail, MapPin, Calendar, CreditCard, Phone, TrendingUp, FileText, DollarSign } from "lucide-react";
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      {formatCurrency(cliente.limiteCredito - (estatisticas?.limiteUtilizado || 0))}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${(estatisticas?.saldoAtual || 0) >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0">
                ...
                <Button asChild size="sm">
                  <Link to="/admin/factoring/clientes/$id/editar" params={{ id }}>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <Badge variant={cliente.creditoAutorizado ? "default" : "secondary"}>
                ...
                {(cliente.tarifaDevolucaoCheques || cliente.tarifaProrrogacao || cliente.tarifaProtesto || cliente.tarifaResgate) && (
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">
                    ...
                    <div className="mt-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                      {cliente.tarifaDevolucaoCheques && (
                        <div>
                          <span className="text-xs text-muted-foreground">Devolução de Cheques</span>
                      ...
                      {cliente.tarifaProrrogacao && (
                        <div>
                          <span className="text-xs text-muted-foreground">Prorrogação</span>
                          <div className="font-semibold">
                      ...
                      {cliente.tarifaProtesto && (
                        <div>
                          <span className="text-xs text-muted-foreground">Protesto</span>
                          <div className="font-semibold">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0">
                ...
                <Button asChild size="sm" variant="outline">
                  <Link to="/admin/factoring/pessoas/$id/editar" params={{ id: cliente.pessoaId.toString() }}>
                    <Edit className="h-4 w-4 mr-2" />
                    Editar Pessoa
                  </Link>
                </Button>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <div className="mt-1">
                    <Badge variant={cliente.pessoa.tipoPessoa === "fisica" ? "default" : "secondary"}>
                      {cliente.pessoa.tipoPessoa === "fisica" ? "Pessoa Física" : "Pessoa Jurídica"}
                    </Badge>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 font-mono">
                    {formatDocument(cliente.pessoa.documento, cliente.pessoa.tipoPessoa)}
                  </div>
                </div>

                <div>
                  <label className="text-sm font-medium text-muted-foreground">
                    {cliente.pessoa.tipoPessoa === "fisica" ? "Nome Completo" : "Razão Social"}
                  </label>
