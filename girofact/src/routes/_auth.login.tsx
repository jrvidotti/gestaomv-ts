...
function LoginPage() {
  ...
  const [loginType, setLoginType] = useState<"local">("local");
  const { emailLogin, isAuthenticated, isLoading: authLoading } = useAuth();
        ...
        <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <div className="flex rounded-lg border p-1 mb-6">
              ...
              {/* Adicionar outros métodos de login aqui */}
            </div>
