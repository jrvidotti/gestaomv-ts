...
async function criar(
	...
	const template = await buscar(created.id);
...
async function buscar(id: number): Promise<ChecklistTemplate | null> {
...
async function deletarItem(itemId: number): Promise<boolean> {
