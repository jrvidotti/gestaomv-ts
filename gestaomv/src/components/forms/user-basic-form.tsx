...
export function UserBasicForm({ mode, initialData, onSubmit, isSubmitting = false }: UserBasicFormProps) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {mode === 'create' ? 'Dados do Novo Usuário' : 'Dados Básicos do Usuário'}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {mode === 'create' && (
              <div className="text-sm text-muted-foreground p-4 bg-muted/50 rounded-lg">
                ...
                <p>O usuário será criado inicialmente sem nenhuma permissão específica. 
                   Após a criação, você poderá configurar as permissões necessárias na tela de edição.</p>
              </div>
            )}
