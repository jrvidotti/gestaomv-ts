...
function EditUnidadePage() {
  ...
  // Queries tRPC
  const { data: unidade, isLoading, error } = useQuery(trpc.unidades.findOne.queryOptions({ id }))
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Unidade não encontrada</h3>
                  <p className="text-muted-foreground mb-4">
                    A unidade solicitada não foi encontrada ou você não tem permissão para acessá-la.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="ml-2 text-muted-foreground">
                    {unidade.empresa?.razaoSocial || 'Nenhuma empresa vinculada'}
                  </span>
                </div>
                <div>
