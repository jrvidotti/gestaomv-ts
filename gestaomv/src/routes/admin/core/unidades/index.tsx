...
function UnidadesListPage() {
  ...
  // Queries tRPC
  const { data: unidades, isLoading, error, refetch } = useQuery(trpc.unidades.findAll.queryOptions())
  ...
  const filteredUnidades = unidades?.filter(unidade => 
    ...
    unidade.empresa?.razaoSocial?.toLowerCase().includes(searchTerm.toLowerCase())
  ) || []
                    ...
                    {filteredUnidades.length === 0 ? (
                      <TableRow>
                        <TableCell colSpan={5} className="text-center py-8 text-muted-foreground">
                          {searchTerm ? 'Nenhuma unidade encontrada para a busca' : 'Nenhuma unidade cadastrada'}
                        </TableCell>
                      </TableRow>
                    ) : (
                      filteredUnidades.map((unidade) => (
                        <TableRow 
                          ...
                          onClick={() => navigate({ to: '/admin/core/unidades/$id/edit', params: { id: unidade.id } })}
                        >
                          <TableCell>
                            <div>
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link to="/admin/core/unidades/$id/edit" params={{ id: unidade.id }}>
