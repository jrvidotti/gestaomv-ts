...
function EmpresasListPage() {
  ...
  // Queries tRPC
  const { data: empresas, isLoading, error, refetch } = useQuery(trpc.empresas.findAll.queryOptions())
                    ...
                    {filteredEmpresas.length === 0 ? (
                      ...
                      filteredEmpresas.map((empresa) => (
                        <TableRow 
                          ...
                          onClick={() => navigate({ to: '/admin/core/empresas/$id/edit', params: { id: empresa.id } })}
                        >
                          <TableCell>
                            <div>
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link to="/admin/core/empresas/$id/edit" params={{ id: empresa.id }}>
