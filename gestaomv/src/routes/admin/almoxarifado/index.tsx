...
function RouteComponent() {
	...
	const stats = [
		{
			...
			value: carregandoStats
				? "..."
				: estatisticas?.totalSolicitacoes?.toString() || "0",
		...
		},
		{
			...
			value: carregandoStats
				? "..."
				: estatisticas?.materiaisAtivos?.toString() || "0",
		...
		},
		{
			...
			value: carregandoStats
				? "..."
				: estatisticas?.unidadesAtivas?.toString() || "0",
		...
		},
		{
			...
			value: carregandoStats
				? "..."
				: formatCurrency(estatisticas?.valorTotalSolicitado || 0),
	...
	const dadosStatus = estatisticas
		? [
				{
					name: "Pendente",
					value: estatisticas.solicitacoesPorStatus.pendente,
					color: "#0088FE",
				},
				{
					name: "Aprovada",
					value: estatisticas.solicitacoesPorStatus.aprovada,
					color: "#00C49F",
				},
				{
					name: "Rejeitada",
					value: estatisticas.solicitacoesPorStatus.rejeitada,
					color: "#FF8042",
				},
				{
					name: "Atendida",
					value: estatisticas.solicitacoesPorStatus.atendida,
					color: "#FFBB28",
				},
				...
				<div className="space-y-6">
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Selecione o período e status para análise dos dados
							</CardDescription>
						</CardHeader>
						<CardContent>
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Materiais mais solicitados por categoria
								</CardDescription>
							</CardHeader>
							<CardContent>
								{carregandoTipo ? (
											...
											<div className="flex items-center gap-3">
												...
												<div>
													...
													<p className="text-sm text-muted-foreground">
														{material.materialTipo.replace(/_/g, " ")}
													</p>
												</div>
											</div>
											<div className="text-right">
												<p className="font-semibold">
													{material.totalSolicitado} unidades
												</p>
												<p className="text-sm text-muted-foreground">
													{formatCurrency(material.valorTotal)}
												</p>
												<p className="text-xs text-muted-foreground">
													{material.numeroSolicitacoes} solicitações
												</p>
											</div>
										</div>
									))}
								...
								<div className="grid gap-4 md:grid-cols-4">
									...
									>
										<div className="text-center p-4 border rounded-lg hover:bg-accent cursor-pointer transition-colors">
											...
											<p className="text-2xl font-bold">
												{estatisticas.solicitacoesPorStatus.pendente}
											</p>
									...
									>
										<div className="text-center p-4 border rounded-lg hover:bg-accent cursor-pointer transition-colors">
											...
											<p className="text-2xl font-bold">
												{estatisticas.solicitacoesPorStatus.aprovada}
											</p>
									...
									>
										<div className="text-center p-4 border rounded-lg hover:bg-accent cursor-pointer transition-colors">
											...
											<p className="text-2xl font-bold">
												{estatisticas.solicitacoesPorStatus.atendida}
											</p>
									...
									>
										<div className="text-center p-4 border rounded-lg hover:bg-accent cursor-pointer transition-colors">
											...
											<p className="text-2xl font-bold">
												{estatisticas.solicitacoesPorStatus.rejeitada}
											</p>
											<p className="text-sm text-muted-foreground">
												Rejeitadas
											</p>
