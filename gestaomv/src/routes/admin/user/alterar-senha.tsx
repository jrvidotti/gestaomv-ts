          ...
          <CardContent>
            ...
            >
              ...
              <form.Field
                ...
                children={(field) => (
                  <div className="space-y-2">
                    ...
                    {field.state.value && field.state.value.length >= 6 && !field.state.meta.errors.length && (
              ...
              <form.Field
                ...
                children={(field) => (
                  <div className="space-y-2">
                    ...
                    <form.Subscribe
                      selector={(state) => [state.values.newPassword, state.values.confirmPassword]}
              ...
              <div className="flex gap-3 pt-4">
                <Button
                  type="submit"
                  disabled={changePasswordMutation.isPending || !form.state.canSubmit}
                  className="flex-1"
                >
