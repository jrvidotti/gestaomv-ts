...
export const Route = createFileRoute("/admin/rh/avaliacoes-experiencia/")({
	...
	): AvaliacoesExperienciaSearch => ({
		busca: typeof search.busca === "string" ? search.busca : undefined,
		recomendacao:
			typeof search.recomendacao === "string"
				? (search.recomendacao as RecomendacaoExperienciaType)
				: undefined,
		departamentoId:
...
function RouteComponent() {
	...
	const [recomendacaoSelecionada, setRecomendacaoSelecionada] = useState<
		RecomendacaoExperienciaType | "all"
	>(recomendacaoUrl || "all");
	...
	const filtros: FiltrosAvaliacoesExperiencia = {
		...
		recomendacao:
			recomendacaoSelecionada && recomendacaoSelecionada !== "all"
	...
	const { data, isLoading } = useQuery(
		trpc.rh.listarAvaliacoesExperiencia.queryOptions(filtros),
	);
	const { data: funcionariosPendentes, isLoading: isLoadingPendentes } =
		useQuery(
							...
							<Card className="border-orange-200 bg-orange-50">
								<CardHeader>
									...
									<CardDescription className="text-orange-700">
										Funcionários que estão próximos ou já venceram o prazo para
											...
											>
												...
												<div className="text-right">
													<p className="text-sm font-medium">
														{calcularDiasExperiencia(funcionario.dataAdmissao)}{" "}
														dias de experiência
													</p>
												...
												<Link
													to="/admin/rh/avaliacoes-experiencia/nova"
													search={{ funcionarioId: funcionario.id.toString() }}
												>
													<Button size="sm">
							...
							<div className="flex flex-col gap-4 lg:flex-row lg:items-end">
								...
								<div>
									...
									<Select
										...
										onValueChange={(value) =>
											setRecomendacaoSelecionada(
												value as RecomendacaoExperienciaType | "all",
											)
										}
									>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								{isLoading
									? "Carregando..."
									: `${data?.total || 0} avaliações encontradas`}
							</CardDescription>
						</CardHeader>
						<CardContent>
							{isLoading ? (
												...
												<TableRow key={avaliacao.id}>
													<TableCell>
														<div className="flex items-center gap-3">
															<Avatar className="h-10 w-10">
																<AvatarImage
																	src={avaliacao.funcionario.foto || undefined}
																/>
																<AvatarFallback>
													...
													<TableCell>
														<DropdownMenu>
															...
															<DropdownMenuContent align="end">
																<Link
																	to="/admin/rh/avaliacoes-experiencia/$id"
																	params={{ id: avaliacao.id.toString() }}
																>
																	<DropdownMenuItem>
