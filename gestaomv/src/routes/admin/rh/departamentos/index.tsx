...
import { Building2, Plus, Search, MoreHorizontal, Pencil, Eye, Trash2, Filter } from 'lucide-react'
...
function RouteComponent() {
  ...
  const handleRemover = async (id: number, nome: string) => {
    if (confirm(`Deseja realmente remover o departamento "${nome}"? Esta ação não pode ser desfeita.`)) {
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Use os filtros abaixo para encontrar departamentos específicos</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {isLoading ? 'Carregando...' : `${data?.total || 0} departamentos encontrados`}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                          ...
                          <TableCell>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <Link to="/admin/rh/departamentos/$id" params={{ id: departamento.id.toString() }}>
                                  <DropdownMenuItem>
                                    <Eye className="h-4 w-4 mr-2" />
                                    Visualizar
                                  </DropdownMenuItem>
                                </Link>
                                <Link to="/admin/rh/departamentos/$id/edit" params={{ id: departamento.id.toString() }}>
                                  <DropdownMenuItem>
                                ...
                                <DropdownMenuItem
                                  onClick={() => handleRemover(departamento.id, departamento.nome)}
