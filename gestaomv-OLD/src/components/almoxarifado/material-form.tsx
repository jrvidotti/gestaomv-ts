...
import { atualizarMaterialSchema, criarMaterialSchema, Material, TipoMaterial, UnidadeMedida } from '@/shared';
import { api } from '@/lib/trpc';
import { LookupSelect } from '../lookup-select';

type MaterialFormData = z.infer<typeof criarMaterialSchema>;
...
export function MaterialForm({
  ...
  const formSchema = mode === 'create' ? criarMaterialSchema : atualizarMaterialSchema;
  ...
  const { data: unidadesMedidaData, isLoading: isLoadingUnidadesMedida } =
    api.almoxarifado.listarUnidadesMedida.useQuery();
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      ...(mode === 'edit' && { ativo: initialData?.ativo ?? true }),
    },
  });
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Papel A4, Caneta Azul..." {...field} disabled={isSubmitting || isLoading} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <LookupSelect
                        ...
                        disabled={isSubmitting || isLoading || isLoadingTiposMaterial}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <LookupSelect
                        ...
                        emptyMessage={isLoadingUnidadesMedida ? 'Carregando...' : 'Nenhuma unidade selecionada'}
                        disabled={isSubmitting || isLoading || isLoadingUnidadesMedida}
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Opcional. Faça upload de uma imagem do material (JPG, PNG ou WebP, máximo 5MB).
                  </p>
                </FormItem>
              )}
            />
