...
import { STATUS_OPTIONS, STATUS_SOLICITACAO, STATUS_SOLICITACAO_DATA, StatusSolicitacaoType } from '@/shared';
...
export default function SolicitacoesPage() {
  ...
  const [statusSelecionado, setStatusSelecionado] = useState<StatusSolicitacaoType | 'all'>('all');
  ...
  const { data, isLoading, refetch } = api.almoxarifado.listarSolicitacoes.useQuery(filtros);
                          ...
                          <TableCell>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <Link href={`/admin/almoxarifado/solicitacoes/${solicitacao.id}`}>
                                  <DropdownMenuItem>
