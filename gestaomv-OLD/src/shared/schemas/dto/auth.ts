import { z } from 'zod';
import { USER_ROLES, USER_ROLES_ARRAY, UserRoleType } from '../../constants';
...
export const createUnidadeSchema = z.object({
  ...
  codigo: z.number().int().positive('Código deve ser um número positivo inteiro'),
  empresaId: z.number().int().positive('ID da empresa deve ser um número positivo').optional(),
  endereco: z.string().optional(),
  cidade: z.string().optional(),
  estado: z.string().optional(),
  telefone: z.string().optional(),
  pontowebId: z.number().int().positive('ID do Pontoweb deve ser um número positivo').optional(),
});

export const updateUnidadeSchema = z.object({
  nome: z.string().min(2, 'Nome deve ter pelo menos 2 caracteres').optional(),
  codigo: z.number().int().positive('Código deve ser um número positivo inteiro').optional(),
  empresaId: z.number().int().positive('ID da empresa deve ser um número positivo').optional().nullable(),
  endereco: z.string().optional(),
  cidade: z.string().optional(),
  estado: z.string().optional(),
  telefone: z.string().optional(),
...
export const updateEmpresaSchema = z.object({
  ...
  nomeFantasia: z.string().optional(),
  cnpj: z.string().min(14, 'CNPJ deve ter 14 dígitos').max(18, 'CNPJ inválido').optional(),
  pontowebId: z.number().int().positive('ID do Pontoweb deve ser um número positivo').optional(),
});
