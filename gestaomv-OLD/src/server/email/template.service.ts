...
export class TemplateService {
   ...
   */
  renderWelcomeSubject(data: Pick<WelcomeEmailData, 'name' | 'companyName'>): string {
   ...
   */
  renderSolicitacaoCriadaSubject(data: Pick<SolicitacaoCriadaEmailData, 'solicitacao'>): string {
    const template = this.loadTemplate('almoxarifado/solicitacao-criada.subject');
    return template(data);
  }
   ...
   */
  renderSolicitacaoAprovadaSubject(data: Pick<SolicitacaoAprovadaEmailData, 'solicitacao'>): string {
    const template = this.loadTemplate('almoxarifado/solicitacao-aprovada.subject');
    return template(data);
  }
   ...
   */
  renderSolicitacaoRejeitadaSubject(data: Pick<SolicitacaoRejeitadaEmailData, 'solicitacao'>): string {
    const template = this.loadTemplate('almoxarifado/solicitacao-rejeitada.subject');
    return template(data);
  }
}
