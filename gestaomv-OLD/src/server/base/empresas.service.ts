...
import { Empresa, empresas, type CreateEmpresaDto, type UpdateEmpresaDto } from '@/shared';
...
export class EmpresasService {
  ...
  async update(id: number, empresaData: UpdateEmpresaDto): Promise<Empresa | undefined> {
    const updateData = {
      ...empresaData,
