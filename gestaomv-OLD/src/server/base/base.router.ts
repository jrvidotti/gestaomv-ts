  ...
  createRouter() {
    return this.trpcService.router({
      ...
      users: this.trpcService.router({
        ...
        findOne: this.trpcService.adminProcedure.input(z.object({ id: z.number() })).query(async ({ input }) => {
        ...
        create: this.trpcService.adminProcedure.input(createUserSchema).mutation(async ({ input }) => {
        ...
        update: this.trpcService.adminProcedure
          ...
          .mutation(async ({ input }) => {
            ...
            const user = await this.usersService.update(input.id, userData, roles);
            if (!user) {
              throw new Error('Usuário não encontrado');
            }
            const { password, ...userWithoutPassword } = user;
        ...
        remove: this.trpcService.adminProcedure.input(z.object({ id: z.number() })).mutation(async ({ input }) => {
      ...
      empresas: this.trpcService.router({
        ...
        findByCnpj: this.trpcService.adminProcedure.input(z.object({ cnpj: z.string() })).query(async ({ input }) => {
        ...
        findByPontowebId: this.trpcService.adminProcedure
          ...
          .query(async ({ input }) => {
            const empresa = await this.empresasService.findByPontowebId(input.pontowebId);
            if (!empresa) {
              throw new Error('Empresa não encontrada');
            }
            return empresa;
        ...
        create: this.trpcService.adminProcedure.input(createEmpresaSchema).mutation(async ({ input }) => {
          const empresaExistente = await this.empresasService.findByCnpj(input.cnpj);
          if (empresaExistente) {
        ...
        update: this.trpcService.adminProcedure
          ...
          .mutation(async ({ input }) => {
            if (input.data.cnpj) {
              const empresaExistente = await this.empresasService.findByCnpj(input.data.cnpj);
              if (empresaExistente && empresaExistente.id !== input.id) {
                throw new Error('CNPJ já cadastrado no sistema');
              }
            }

            const empresa = await this.empresasService.update(input.id, input.data);
            if (!empresa) {
              throw new Error('Empresa não encontrada');
            }
            return empresa;
      ...
      unidades: this.trpcService.router({
        ...
        findByCodigo: this.trpcService.adminProcedure
          ...
          .query(async ({ input }) => {
            const unidade = await this.unidadesService.findByCodigo(input.codigo);
            if (!unidade) {
              throw new Error('Unidade não encontrada');
            }
            return unidade;
        ...
        create: this.trpcService.adminProcedure.input(createUnidadeSchema).mutation(async ({ input }) => {
        ...
        update: this.trpcService.adminProcedure
          ...
          .mutation(async ({ input }) => {
            const unidade = await this.unidadesService.update(input.id, input.data);
            if (!unidade) {
              throw new Error('Unidade não encontrada');
            }
            return unidade;
      ...
      configuracoes: this.trpcService.router({
        getConfiguracoesSistema: this.trpcService.adminProcedure.query(async () => {
        ...
        updateConfiguracoesSistema: this.trpcService.adminProcedure
          ...
          .mutation(async ({ input }) => {
            return await this.configuracoesService.updateConfiguracoesSistema(input);
          }),

        initializeDefaultSettings: this.trpcService.adminProcedure.mutation(async () => {
