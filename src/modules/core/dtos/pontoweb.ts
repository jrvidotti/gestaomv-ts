...
export type ImportarFuncionariosData = z.infer<
	typeof importarFuncionariosSchema
>;
export type SincronizarAfastamentosData = z.infer<
	typeof sincronizarAfastamentosSchema
>;
